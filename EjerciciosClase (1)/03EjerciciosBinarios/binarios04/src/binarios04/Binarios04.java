...
/**
Programa Java que lee el contenido del fichero creado en el Ejemplo 2 y lo muestra 
por pantalla. 
*/
public class Binarios04 {

    public static void main(String[] args) {
        FileInputStream fis = null;
        DataInputStream entrada = null;
        int filas, columnas, i, j;
        try {//los dos primeros elementos son int y el resto double
